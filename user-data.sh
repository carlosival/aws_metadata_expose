...
instance_ids="i-08a58a649478a4f81"
...
dns_public_name=$(aws ec2 describe-instances --instance-id i-08a58a649478a4f81 --query 'Reservations[*].Instances[*].PublicDnsName' --r$
